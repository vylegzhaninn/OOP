...
/**
 * Тесты для проверки последовательного алгоритма поиска простых чисел.
 */
public class SequentialSolTest {
    ...
    void testArrayWithPrime() throws InterruptedException {
        ...
        Assertions.assertTrue(SequentialSol.sequentialSolution(arr));
    }
    ...
    void testArrayWithoutPrime() throws InterruptedException {
        ...
        Assertions.assertFalse(SequentialSol.sequentialSolution(arr));
    }
