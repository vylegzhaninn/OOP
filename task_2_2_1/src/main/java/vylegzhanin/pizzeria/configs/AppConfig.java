 ...
 * @param workTime         максимальное время выполнения одного заказа работником, мс
 *                         (JSON: {@code "WorkTime"})
 * @param trankSize        максимальный суммарный размер заказов в багажнике курьера
 *                         (JSON: {@code "TrunkSize"})
 * @param orderInterval    интервал между генерацией новых заказов, мс
 *                         (JSON: {@code "OrderInterval"})
