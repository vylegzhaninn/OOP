...
class ScoreCalculatorTest {
    ...
    void appliesLatePenaltyAndBonus() {
        TaskSpec task = new TaskSpec("t1", "Task", 10, LocalDate.of(2026, 4, 10), LocalDate.of(2026, 4, 20));
        SubmissionSpec submission = new SubmissionSpec("octo", "t1", LocalDate.of(2026, 4, 15), 1.0);

        RepoRunResult run = new RepoRunResult(true, true, true, true, true, 8, 2, 0, "");
        TaskScoreResult result = new ScoreCalculator().calculate(task, submission, run, SettingsSpec.defaults());
